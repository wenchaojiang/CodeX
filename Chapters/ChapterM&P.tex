...
In the third iteration, we improved system stability and interface design. We conducted a pilot study at the campus of another university, to test the system in place. The full-fledged studies we report on later in Chapter \ref{ch:studyone}, \ref{ch:studytwo} and \ref{ch:studythree} was conducted shortly thereafter.\\
