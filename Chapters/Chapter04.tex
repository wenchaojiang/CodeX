...
\texttt{
\textbf{KY:} So we have to run! [through the radiation] JH: Do we have to run through the (.) through the radiation? ((looking at map)) \\
...
\emph{ [KY JH begin running into the cloud]\\ }
\end{minipage}}
\includegraphics[width=.5\textwidth]{img/study1/ep1/ep13}
\includegraphics[width=.5\textwidth]{img/study1/ep1/ep14}
\hfill \break
\noindent\Mybox{\begin{minipage}[b]{\textwidth}
\texttt{
...
\emph{ [They turn around and run back out of the cloud without the fuel.]\\ }
}
\end{minipage}} 
\hfill \break
...
\noindent \includegraphics[width=.5\textwidth]{img/study1/ep2/ep21}
\noindent \includegraphics[width=.5\textwidth]{img/study1/ep2/ep22}
\hfill \break
\noindent\Mybox{\begin{minipage}[b]{\textwidth}
...
\textbf{BR:} ((glances MF`s screen)) I think there are two people going for that. I think we should go for this one ((points at screen)).\\
...
The missing of remote coordination and the weak role of HQ in the planning activities may indicate communication breakdown, which is also indicated by series of observations of understanding and confusions in the communication channel (see x.x.x).\\

From this perspective, the domination of local coordination . Some of the reasons?


\subsection{Accountability}
The natural social order that employed by the team members to make sense of the task environment. Players are observed to constantly revealing to others their action and plans via face to face conversation. 

CSCW concern that Geo distribution hinders team member's attempt maintain accountability . The lack of response in the communication channel shows that. The form of communication in this study appears to be unable to support the team member's accountability. 
