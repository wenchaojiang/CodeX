...
%************************************************
The section will present the results of a workshop we conducted with a professional disaster response charity organisation called Rescue Global(RG). The purpose of these workshop is to get professional feedbacks about the AtomicOrchid(AO) platform to understand [strength], limitations and potentials of the disaster simulation based on AO. The workshop is centred on a demonstration of HACs system for disaster response (DR). The AO is a component of the HACs demo system. Others components include information crowdsourcing, multi-UAV control interface for DR, and DR operation provenance store [see HACer paper]. Each component are allocated one session (about 45 mins). The AO session is structured as follows:\\
...
\section{The Rescue Global feedbacks}
The realistic of the AO ? 
...
In terms of Command and Control structure, probably not? 
Refers to functional and geographical sectoring of command. Strategic and tactical divide (Bronze, silver , gold)
...
We identify needs and we give the need data to the team who have the resources to meet it. And often what we say is how to get that from A to B. Also, A need food and B has food, we provide transport. 
