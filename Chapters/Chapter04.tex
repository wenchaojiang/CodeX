...
%************************************************
\chapter{Professional feedbacks}\label{ch:rgworkshop} 
%************************************************
The section will presents xxx, The purpose is to professional feedbacks about the similarity and the divide between the AtomicOrchid platform and real disaster operation of the . The feedback  contribute to our understanding of limitation of this PhD work

\section{Design of workshop} 
A HACer demonstration combines four sessions with different themes and hand-on experiences. The AtomicOrchid is one of the session. The whole demonstration envisions the future HACs systems (cite the section and the paper). It is structured in a way that allows story telling of a disaster scenario with which the envisioned HACs system will operate on (see table x.x.x). 

% insert a table. 

\section{Introduction of Rescue Global}
Rescue Global (RG) is a disaster response organisation. They are a UK charity and a US not-for-profit headquartered in London, UK. Their remit is to provide “immediate crisis and disaster reconnaissance ability, delivering accurate and timely information and risk data, as well as performing emergency search and rescue operations where needed to save life.” [30]. RG has adopted a framework of procedures that implements ISO 9001 Quality Management (QM) principles, which commits RG for example to conduct risk assessments and to record decisions for accountability purposes. This has implications on the ways in which missions are planned and carried out (the focus of our field work).
