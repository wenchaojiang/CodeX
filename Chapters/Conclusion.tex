...
In term of data analysis, the result may not have quantitative robustness because we only conducted 6 game trials. This limitation is actually a limitation of the data analysis method we apply, namely interaction analysis. The method is extremely time consuming, thus limiting the number of data we can analysis \cite{Crabtree2012}. Generality of the results may have to be established with other means. However, this limitation do not affects the descriptive power of qualitative approach of analysis. \\
