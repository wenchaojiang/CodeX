...
\begin{itemize} 
  \item Human Computer Interaction (HCI). HCI is the overarching research area of the PhD work. This thesis follows a long-standing tradition to of empirical CSCW study, which investigates complex settings collaborative work setting and identify implications for technology support. Two other sub domains of HCI, namely automation design and human agent interaction, provide framework models and terminologies to design interaction for field trials.
